...
async def get_medical_service_svc(medical_service_repo: MedicalServiceRepository = Depends(get_medical_service_repo)) -> AsyncGenerator[MedicalServiceService, None]:
    yield MedicalServiceService(medical_service_repo)