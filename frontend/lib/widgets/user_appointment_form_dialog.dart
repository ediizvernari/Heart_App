...
class _UserAppointmentFormDialogState extends State<UserAppointmentFormDialog> {
  ...
  Future<void> _initLoad() async {
    ...
    final slotCtl = context.read<FreeSlotController>();
  ...
  void _reloadSlots() {
    ...
    context.read<FreeSlotController>().loadFreeTimeSlotsForAssignedMedic(
      isoDate: isoDate,
  ...
  Widget build(BuildContext context) {
    ...
    final slotCtl = context.watch<FreeSlotController>();
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    else if (slotCtl.freeSlots.isEmpty)
                      const Text('No available slots', style: TextStyle(color: Colors.grey))
                    else
                      SizedBox(
                        height: 200,
                        child: ListView.separated(
                          itemCount: slotCtl.freeSlots.length,
                          separatorBuilder: (_, __) => const Divider(),
                          itemBuilder: (_, i) {
                            final slot = slotCtl.freeSlots[i];
